...
/**
 * 마인크래프트 기본 GUI의 TextField 를 상속받은 AE2의 TextField 대체 클래스
 *
 * @author mojang, nemocraft
 */
@SideOnly(Side.CLIENT)
public class AEMEGuiTextField extends MEGuiTextField
{
	/**
	...
	public AEMEGuiTextField(FontRenderer par1FontRenderer, int xPos, int yPos, int width, int height)
	{
